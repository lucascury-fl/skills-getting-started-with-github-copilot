...
activities = {
    ...
    "Science Club": {
        "description": "Explore biology, physics, and chemistry through experiments",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    if isinstance(max_participants, int) and max_participants > 0:
        if len(activity["participants"]) >= max_participants:
            raise HTTPException(status_code=409, detail="Activity is full; no remaining spots available")
